...
st.image("https://drive.usercontent.google.com/download?id=12tR0OZWicqlh8yVJCJLi70OdkDyn_ZlO&authuser=0", caption="Descripción de la imagen", use_column_width=True) 
